...
namespace SimpleBendingDetail
{
    internal class BendindDetail
    {
        ...
        public BendindDetail(Document doc, View view, Rebar rebar)
        {
            ...
            //{
            //    if (OrientLabel(this.segments[i]))
            //    {
            //        this.segments[i].MinLabel *= -1;
            //    }
            //}

            //if (rebar.GetHookTypeId(0) != ElementId.InvalidElementId ) //has start hook
            //{
            //    if (OrientLabel(this.hook0Segment))
            //    {
            //        this.hook0Segment.MinLabel *= -1;
            //    }
            //}
            //else if (rebar.GetHookTypeId(1) != ElementId.InvalidElementId) //has end hook
            //{
            //    if (OrientLabel(this.hook1Segment))
            //    {
